...
aliases:
  - p Chart
  - Proportion Nonconforming Chart
---
...
| Related note | Use |
|---|---|
| [[np Chart|np chart]] | Fixed sample-size count of nonconforming units |
| [[c Chart|c chart]] | Defect counts, constant opportunity |
| [[Defects per Unit|u chart]] | Defect rates, variable opportunity |
| [[Control Charts|Control charts]] | Attribute chart taxonomy |
