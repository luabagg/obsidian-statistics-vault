...
[[Functions]]; coordinate geometry from [[Geometria Analítica]] (especially [[Vectors and Dot Product]]). Comfortable algebra with systems of equations.
...
- Numerical methods for systems: topics under [[Métodos Numéricos]] (e.g. Gaussian elimination notes in that tree when present)
