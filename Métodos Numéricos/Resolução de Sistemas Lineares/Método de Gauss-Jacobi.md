...
Converges for every start iff $\rho(T_J)<1$. Strict diagonal dominance of $A$ is sufficient. See [[Teorema Condição Suficiente de Converência do Método de Gauss-Jacobi]].
