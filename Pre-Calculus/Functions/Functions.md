...
Prerequisites: real numbers, coordinate plane, solving basic equations. Hub: [[Pre-Calculus]].
...
- Related: [[Polynomials and Rational Functions]], [[Exponentials and Logarithms]], [[Trigonometry]]
- Next: polynomial/rational behavior, then exponential/log and trig functions
- Later: limits and continuity in [[Calculus]]
